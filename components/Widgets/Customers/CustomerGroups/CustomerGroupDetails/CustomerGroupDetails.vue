        ...
        <div class="flex bg-white items-center gap-3 flex-row border rounded-t-lg p-5">
            ...
            <div class="ml-auto">
                <Dialog>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Are you sure you want to delete this customer group?</DialogTitle>
                        ...
                        <DialogFooter class="flex flex-row gap-2 justify-end">
                            ...
                            <button @click="deleteCustomerGroup"
        ...
        <SheetContent :side="$viewport.isGreaterThan('tablet') ? 'right' : 'bottom' ">
            ...
            <div class="flex flex-col w-full gap-5 p-3">
                ...
                <div class="flex flex-row gap-2 justify-end">
                    ...
                    <button :disabled="editForm.saving" @click="saveCustomerGroupDetails"
...
import { updateCustomerGroup, deleteCustomerGroup } from '@/services/customers';
...
export default {
    ...
    methods: {
        ...
        async saveCustomerGroupDetails() {
            this.v$.$validate()
            if (this.v$.$errors.length === 0) {
                try {
                    this.editForm.saving = true;
                    const group = await updateCustomerGroup(this.group.id, this.editForm.values);
                    this.$emit('updated');
        ...
        async deleteCustomerGroup() {
            try {
                const deleted = await deleteCustomerGroup(this.group.id);
