...
watch(rowSelection, () => {
    emits('update:selected', table.getFilteredSelectedRowModel().rows.map((row) => ({ options: row.original, price: '', stock: 10000, allowBackOrder: false, manageInventory: false, media: [], thumb: null })));
}, { deep: true });
