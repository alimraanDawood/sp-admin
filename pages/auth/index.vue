<template>
    <div class="flex flex-col h-screen w-screen bg-black/5 justify-end">
        <div class="flex flex-col shadow ">
            <div class="flex flex-row p-3 items-center justify-between rounded-t-xl border bg-[#fafafa]">
                <button class="text-sm font-medium text-primary">Cancel</button>
            ...
            <div class="flex flex-col w-full p-3 gap-5 bg-white">
                ...
                <div class="flex flex-col">
                    <button class="flex flex-row w-full p-2 rounded bg-primary text-white items-center justify-center font-medium" v-wave>Sign In</button>
                </div>
                ...
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <div class="flex flex-row items-center gap-2 justify-center">
                        <button class="border bg-black/5 p-2 rounded-lg">
                ...
                <div class="flex flex-row items-center font-medium text-center text-sm">
